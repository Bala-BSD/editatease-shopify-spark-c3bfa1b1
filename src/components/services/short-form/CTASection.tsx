      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-4xl md:text-6xl font-bold mb-6">
            Let's Edit Your <span className="bg-gradient-primary bg-clip-text text-transparent">Next Viral Video</span>
          </h2>
          
          <p className="text-xl text-muted-foreground mb-8">
            Your brand deserves scroll-stopping edits.
            <br />
            🎬 Upload your footage today — we'll handle the rest.
          </p>
