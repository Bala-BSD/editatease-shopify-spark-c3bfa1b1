          ...
          <Card className="p-8 bg-gradient-subtle border-primary/20">
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <h3 className="font-semibold mb-2 group-hover:text-primary transition-colors">WhatsApp Us</h3>
              ...
              <Link to="/contact" className="flex flex-col items-center text-center group">
                ...
                <h3 className="font-semibold mb-2 group-hover:text-primary transition-colors">Book a Call</h3>
